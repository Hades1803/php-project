...
<div class="container">
    <div class="product-detail">
        <div class="product-image">
            <img src="<?php echo $result['image']; ?>" alt="<?php echo $result['product_name']; ?>">
        </div>
        <div class="product-info">
            ...
            <?php if ($result['is_on_sale'] == 1): ?>
                <p class="product-price" style="text-decoration: line-through;color:#ccc;">
                    <?= number_format($result['price'], 0, ',', '.') ?> VND</p>
                <p class="sale-price" style="color: #e63946;font-size:40px;font-weight:bold;"><?= number_format($result['sale_price'], 0, ',', '.') ?> VND</p>
            <?php else: ?>
